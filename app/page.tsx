...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen overflow-hidden bg-background">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[50vh] sm:min-h-[60vh] lg:min-h-[80vh]">
        {/* Background with better mobile positioning */}
        <div className="absolute inset-0 bg-hero-image bg-cover bg-[center_top_-100px] sm:bg-center bg-fixed" />
        ...
        <div className="container relative z-10 px-4 mx-auto text-center">
          ...
          <div className="max-w-3xl mx-auto space-y-6 duration-1000 delay-300 animate-in fade-in">
            ...
            {/* Buttons with fixed text contrast */}
            <div className="flex-wrap justify-center hidden gap-4 sm:flex">
              <Link
                href="/docs/install"

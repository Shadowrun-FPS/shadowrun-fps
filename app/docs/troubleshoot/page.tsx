    ...
    <>
      ...
      <main className="mx-8 md:ml-16">
        ...
        <div className="mx-auto prose lg:text-justify lg:max-w-7xl lg:prose-xl dark:prose-invert">
          ...
          <p>
            The first time you activate may take up to 20 minutes to load the
          ...
          <ul>
            <p>
              Wait for 5-10 minutes for the window to pop up to allow you to
              type in your newly acquired key. (Not sure why this step takes so
              long, if you believe it fully crashed use win key + tab and drag
              Shadowrun to a 2nd desktop this allows you to open task manager
              and end the process)
            </p>
          </ul>
          <br />
          ...
          <p>
            ...
            game folder, verify the file wasnt saved as dxvk.conf.txt (file save
            as change Save as type: to All Files).
          </p>
          <p>
          ...
          <p>
            The most consistent option to limit frames is by creating or editing
            a text file named dxvk.conf in your game folder [C:\Program Files
            (x86)\Microsoft Games\Shadowrun]
          </p>
          <p>
            The default dxvk.conf is available here with descriptions of what
            the options do
          </p>
          <p className="indent-6">
            tip: d3d9.presentInterval will repeat frames x number of times,
            which is super handy for games that are locked to 60 FPS, they will
            still run at 60 FPS, but Vulkan will make the GPU send 120 FPS to
            the monitor
          </p>

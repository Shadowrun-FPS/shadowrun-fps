  ...
  return (
    <>
      ...
      <div className="mx-8 mt-16 prose xl:mx-auto lg:text-justify lg:max-w-7xl lg:prose-xl dark:prose-invert">
        ...
        <ul>
          <li>
            Game 1 - The team indicated by the bot has the first choice of side
            OR server.
          </li>
          <li>
        ...
        <p>
          ...
          dodge after teams have been created, then that player will be
        ...
        <p>
          ...
          has been determined that a ban is necessary, the offender will receive
          a ban beginning at the time of infraction through the end of the
        ...
        <p>
          Once a review is completed, if found guilty, the offender will receive
          a ban beginning at the time of infraction through the end of the
          following day for first offenders. If a player is a repeat offender,
          an additional 24 hours will be added for every subsequent offense.
          Repeat offenders and/or extreme cases may be subject to longer/more
        ...
        <p>
          ...
          dodging. If 4/7 players vote that the accused player is intentionally
          queue dodging, then the evidence must be submitted to Staff (via DM)
          for review.{" "}
        </p>

        ...
        <div className="mx-8 prose xl:mx-auto md:text-justify md:mx-auto lg:prose-xl dark:prose-invert">
          ...
          <section id="game-setup-rules">
            ...
            <ul>
              ...
              <li className="mb-0">
                ...
                games 1 & 2 will choose EITHER the Side, OR Server, and the
                other team will receive the remaining choice of Side, or Server.
              </li>
              <p className="mt-0 text-base italic indent-8 not-prose">
                *In the event of a tie in rounds won between games 1 & 2, a coin
                will be flipped to determine who gets the first choice of Side,
                or Server.
              </p>
            </ul>
          </section>
          ...
          <section id="ranked-rules">
            ...
            <div className="list-decimal">
              ...
              <li>
                ...
                player will be penalized per the Penalties section of the rules.
              </li>
              <li>
          ...
          <section id="leaving-early">
            ...
            <p>
              ...
              other 7 players involved in the match, regardless of the reason
              for leaving, in order for any potential ban to take effect.
            </p>

            <p>
              Staff will then conduct a review. Once a review is completed, if
              it has been determined that a ban is necessary, the offender will
              receive a ban beginning at the time of infraction through the end
              of the following day for first offenders. If a player is a repeat
            ...
            <p>
              ...
              completed games normally. Staff and remaining participants will
              then determine how any incomplete games shall be scored. The match
              may then be subject to Elo adjustment if Participants & Staff deem
              necessary.
            </p>
          </section>
          <section id="griefing">
          ...
          <section id="frame-manipulation">
            ...
            <p>
              If a player is caught manipulating their frame rate to increase
              jump height, the offense must be called out to Staff (via DM) by
              at least 1 of the other 7 players involved in the match and
              evidence must be submitted to Staff (via DM) for review.
            </p>

...
export default function InstallPage() {
  return (
    <>
      <DocHero title={""} />
      <div className="mx-8 mt-2 dark:prose-invert">
        <div className="mx-auto prose lg:prose-xl dark:prose-invert">
          ...
          <br />
          <h2 className="mb-8">Free Installation Guide</h2>
          <h3>Step 1</h3>
          <p>
            Download & Install:{" "}
          ...
          <div>
            ...
            <p>
              ...
              times with no ties to account or computer. This means you can
              share your key with anyone until the key is permanently used up.
            </p>
            <p>

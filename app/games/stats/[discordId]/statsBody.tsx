    ...
    <div className="flex items-center justify-center md:ml-10 md:pl-10">
      <div>
        ...
        <div className="flex items-center justify-center pl-10 text-2xl md:pl-0">
          Highest Ranking Stats: {highestEloStat.teamSize}v
          {highestEloStat.teamSize}
        </div>
        <br />
        <div className="pl-10 md:pl-0">
          ...
          <div className="text-sm">
            Last Match Played:{" "}
            {moment(highestEloStat.lastMatchDate).format("MMM Do YYYY")}
          </div>
        </div>
        <br />
      </div>
    ...
    rows.push(
      <div
        className={
          ...
          (rows.length % 2 ? " md:border-r-4 md:pl-10" : "")
        }
      >
        <div>
          <br />
          <div className="text-2xl">
            {stat.teamSize}v{stat.teamSize} Stats
          </div>
          <br />
          <div className="flex text-xl">
            ELO:&nbsp;
          ...
          <div className="text-sm">
            Last Match Played:{" "}
            {moment(stat.lastMatchDate).format("MMM Do YYYY")}
          </div>
          <br />
        </div>
      </div>
